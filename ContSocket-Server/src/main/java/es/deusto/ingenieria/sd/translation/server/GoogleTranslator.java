...
public class GoogleTranslator {
	...
	public String translate(String langFrom, String langTo, String text) throws Exception {
		...
		if (uri != null && obj != null) {//Aqui se hace la peticion
			con = (HttpURLConnection) obj.openConnection();
		}

		con.setRequestProperty("User-Agent", "Mozilla/5.0");//Aqui se marca que tipo de agente soy, si no se pone sigue funcionando
